...
local function formatTime(epochms)  -- from /lib/core/full_ls.lua
  local month_names = {i18n['jan'],i18n['feb'],i18n['mar'],i18n['apr'],i18n['may'],i18n['jun'],
...
for _, arg in ipairs(args) do
  ...
  if not real then
    die(i18n['cannotaccess'] .. " ", path, ": ", reason or i18n['unknownerror'])
  elseif not fs.exists(path) then
    die(i18n['cannotaccess'] .. " ", path, ":", i18n['nosuchfile'])
  else
